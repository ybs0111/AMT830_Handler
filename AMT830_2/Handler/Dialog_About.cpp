...
void CDialog_About::OnSetUserControl() 
{
	...
	mp_imgAbout.AddTextLine(_T("AMT830 STD Heat Sink"));
	mp_imgAbout.AddTextLine(_T(""));
	...
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T("Manufacturing Date : 2017-05-10"));
	mp_imgAbout.AddTextLine(_T("Update Info        : 2017-05-10"));
	...
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T("Copyright(C) 2017.05.10"));
...
{
	CString sUpdateInfoFile = _T("C:\\AMT830\\System\\Update.Info");
