...
void CScreenMotor::OnInitButton()
{
	...
	switch (clsExcel.m_nAxisDirection[m_nMotorPartNum][m_nMotorPartAxisNum])
	{
		...
		case 1:
			m_btnLeft.SetBitmaps(IDC_BTN_LEFT, IDB_RIGHT_M_DN, WINDOW_DN, IDB_RIGHT_M_UP, WINDOW_UP);

			m_btnRight.SetBitmaps(IDC_BTN_RIGHT, IDB_LEFT_P_DN, WINDOW_DN, IDB_LEFT_P_UP, WINDOW_UP);
			break;
