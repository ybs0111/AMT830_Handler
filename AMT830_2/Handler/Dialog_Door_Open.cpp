...
{
	m_btnDoorOpen.SetBitmaps(IDC_DIALOG_DOOR_OPEN, IDB_BITMAP_DOOR_OPEN, WINDOW_DN, IDB_BITMAP_DOOR_OPEN, WINDOW_UP);
	...
	m_btnDoorClose.SetBitmaps(IDC_DIALOG_DOOR_CLOSE, IDB_BITMAP_DOOR_CLOSE, WINDOW_DN, IDB_BITMAP_DOOR_CLOSE, WINDOW_UP);
