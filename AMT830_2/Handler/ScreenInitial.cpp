...
*/
		...
		case 500:
			...
			else
			{
				...
				{
					//nRet[1] = CTL_Lib.Initialize_motor_board(1,  _T("d:\\AMT8562\\Handler\\amt8562.cme2"));			// MOTOR 보드 초기화 여부 검사한다
					//kwlee 2017.0510
					nRet[1] = CTL_Lib.Initialize_motor_board(1,  _T("c:\\AMT30\\Motor\\amt830.cme2"));			// MOTOR 보드 초기화 여부 검사한다
...
// 						}
		...
		case 1000:
// 			if (st_sync_info.nInitBcrRbt == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(3);
// 				st_sync_info.nInitBcrRbt		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitCokRbt == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(4);
// 				st_sync_info.nInitCokRbt		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitEmptyStk == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(5);
// 				st_sync_info.nInitEmptyStk		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLdRbt == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(6);
// 				st_sync_info.nInitLdRbt		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLdBuff == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(7);
// 				st_sync_info.nInitLdBuff		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLdTrayCvy == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(8);
// 				st_sync_info.nInitLdTrayCvy		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLdTrayPlate == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(9);
// 				st_sync_info.nInitLdTrayPlate	= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLdTrayShifter == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(10);
// 				st_sync_info.nInitLdTrayShifter	= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitLfMP == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(11);
// 				st_sync_info.nInitLfMP		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitRejBuff == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(12);
// 				st_sync_info.nInitRejBuff		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitRetBuff == INIT_READY)
// 			{
// 				m_nProcessStep					+= 5;
// 
// 				OnInitChangeStatus(13);
// 				st_sync_info.nInitRetBuff		= INIT_COMPLETE;
// 			}
// 			
// 			if (st_sync_info.nInitRiMP == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(14);
// 				st_sync_info.nInitRiMP		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitTSiteRbt == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(15);
// 				st_sync_info.nInitTSiteRbt		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitUnldRbt == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(16);
// 				st_sync_info.nInitUnldRbt		= INIT_COMPLETE;
// 			}
// 
// 			if (st_sync_info.nInitUnldBuff == INIT_READY)
// 			{
// 				m_nProcessStep					+= 4;
// 
// 				OnInitChangeStatus(17);
// 				st_sync_info.nInitUnldBuff		= INIT_COMPLETE;
// 			}
// 
...
// 			&&	st_sync_info.nInitLdTrayPlate		== INIT_COMPLETE && st_sync_info.nInitLdTrayShifter		== INIT_COMPLETE
// 			&&	st_sync_info.nInitLdRbt				== INIT_COMPLETE && st_sync_info.nInitLdBuff			== INIT_COMPLETE
// 			&&	st_sync_info.nInitEmptyStk			== INIT_COMPLETE && st_sync_info.nInitRejBuff			== INIT_COMPLETE
// 			&& st_sync_info.nInitCokRbt				== INIT_COMPLETE
// 			//&&	st_sync_info.nInitRetBuff			== INIT_COMPLETE && st_sync_info.nInitCokRbt			== INIT_COMPLETE
// 			&&	st_sync_info.nInitUnldTrayPlate		== INIT_COMPLETE && st_sync_info.nInitUnldTrayShifter	== INIT_COMPLETE
// 			&&	st_sync_info.nInitUnldRbt			== INIT_COMPLETE && st_sync_info.nInitUnldBuff			== INIT_COMPLETE
// 			&&	st_sync_info.nInitUnldTrayStk		== INIT_COMPLETE && st_sync_info.nInitTSiteRbt			== INIT_COMPLETE
// 			&& st_sync_info.nInitLfMP				== INIT_COMPLETE &&	st_sync_info.nInitRiMP				== INIT_COMPLETE 
