...
//  		str_day_path = _T("d:\\AMT8562\\Alarm\\Daily\\DY") + strFileDay + _T(".TXT");
		//kwlee 2017.0510
		str_month_path = _T("c:\\AMT830\\Alarm\\Monthly\\MT") + strFileMonth + _T(".TXT");
		str_day_path = _T("c:\\AMT830\\Alarm\\Daily\\DY") + strFileDay + _T(".TXT");
...
void CMyJamData::OnAlarmInfoLoad()
{
	...
	//strLoadFile = _T("d:\\AMT8562\\Bmp\\Error.txt"); 
	//kwlee 2017.0510
	strLoadFile = _T("c:\\AMT830\\Bmp\\Error.txt"); 
