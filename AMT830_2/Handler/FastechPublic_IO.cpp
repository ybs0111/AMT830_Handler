...
*/	
	...
	FAS_IO.Set_IO_DefineWord(0, 0, 2, 0x0000); //0번 Master, 0번 포트, 2번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료
	FAS_IO.Set_IO_DefineWord(0, 0, 3, 0x00ff); //0번 Master, 0번 포트, 3번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료
	FAS_IO.Set_IO_DefineWord(0, 0, 4, 0x001f); //0번 Master, 0번 포트, 4번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료
	FAS_IO.Set_IO_DefineWord(0, 0, 5, 0x001f); //0번 Master, 0번 포트, 5번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료
	FAS_IO.Set_IO_DefineWord(0, 0, 6, 0x00ff); //0번 Master, 0번 포트, 6번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료
	FAS_IO.Set_IO_DefineWord(0, 0, 7, 0x000f); //0번 Master, 0번 포트, 7번 슬레이브 , 16bit 셋팅			-- Part I/O 검증 완료	
	
	// port 1
	FAS_IO.Set_IO_DefineWord(0, 1, 0, 0x001f); //0번 Master, 1번 포트, 0번 슬레이브 , 16bit 셋팅			
